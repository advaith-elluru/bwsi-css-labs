...
def main():
    ...
    name = "Advaith Elluru" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("Hi everyone. My name is Advaith Elluru and I am a junior in Pennsylvania. A fun fact about me is that I play chess. Looking forward to this course.")
